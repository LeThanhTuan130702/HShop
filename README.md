...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 300d6971-8356-4df2-8806-14bc6c44e026
```

> `300d6971-8356-4df2-8806-14bc6c44e026` is the password of the certificate, you can change it to any password you want.
